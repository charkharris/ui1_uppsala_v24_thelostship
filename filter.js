$(document).ready(function() {
    ...
    function filterSpirits(category) {
        const matchingSpirits = spiritsArray.filter(spirit => spirit.varugrupp === category|| spirit.alkoholhalt > category);
    ...
    const $submitOrderButton = $("<button>").attr("id", "purchase-btn").text("Pruchase");
    ...
    const $clearOrderButton = $("<button>").append('<i class="fas fa-trash-alt"></i>');
